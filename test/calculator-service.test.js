...
describe('calculatorService', () => {
  ...
  describe('calculator', () => {
    ...
    it('should operator not found', async () => {
      ...
      params = { operator: 'div', var1: 10, var2: 0 };
